...
$$x = {-b \pm \sqrt{b^2-4ac} \over 2a}.$$ Maecenas ornare sit amet erat at sollicitudin. Proin sapien elit, varius at massa vitae, dictum interdum erat. Morbi et risus aliquet, faucibus ligula sed, sodales ante. In markdown : `When $a \ne 0$, there are two solutions to \(ax^2 + bx + c = 0\) and they are
